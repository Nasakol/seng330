...
//    public Customer findOwner(@PathVariable("ownerId") int ownerId) {
...
//    public String initCreationForm(Customer owner, ModelMap model) {
//        Event pet = new Event();
//        owner.addPet(pet);
//        model.put("pet", pet);
...
//    public String processCreationForm(Customer owner, @Valid Event pet, BindingResult result, ModelMap model) {
...
//        Event pet = this.clinicService.findPetById(petId);
//        model.put("pet", pet);
//        return VIEWS_PETS_CREATE_OR_UPDATE_FORM;
//    }
//
//    @RequestMapping(value = "/pets/{petId}/edit", method = RequestMethod.POST)
//    public String processUpdateForm(@Valid Event pet, BindingResult result, Customer owner, ModelMap model) {
//        if (result.hasErrors()) {
//            model.put("pet", pet);
//            return VIEWS_PETS_CREATE_OR_UPDATE_FORM;
//        } else {
